...
function Ac(props) {
  ...
  <p className="max-w-4xl mx-auto text-gray-700 mb-10 text-justify">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
    ...
    <div className="flex flex-col items-center">
      ...
      />
      <p className="font-medium">Best in Class Quality</p>
    </div>
    {/* Item 2 */}
    <div className="flex flex-col items-center">
      <img
        ...
        className="w-20 h-20 mb-4"
      />
      <p className="font-medium">Warranty &amp; Door Step Service</p>
    </div>
    {/* Item 3 */}
    <div className="flex flex-col items-center">
      <img
      ...
      />
      <p className="font-medium">Make in India</p>
    </div>
    {/* Item 4 */}
    <div className="flex flex-col items-center">
      <img
        ...
        className="w-20 h-20 mb-4"
      />
      <p className="font-medium">Help Desk &amp; Contact Center</p>
    </div>
  </div>
</section>
