    ...
    <>
      ...
      <section className="w-full bg-white py-10 px-4 md:px-16 text-gray-800">
        <div className="max-w-6xl mx-auto">
          {/* Title */}
          <h2 className="text-3xl md:text-4xl font-semibold font-os mb-6 text-blue-700">Air Monitoring "AeroStar"</h2>

          {/* Description */}
          <p className="text-base sm:text-base md:text-lg font-robo text-justify mb-4">
          ...
          {/* Features */}
          <h3 className="text-2xl md:text-3xl font-os text-blue-600 mt-6 mb-2">Features :</h3>
          <ul className="list-disc list-inside font-robo text-base sm:text-base md:text-lg mb-6 text-justify">
          ...
          {/* Certification */}
          <h3 className="text-2xl md:text-3xl font-os text-blue-600 mt-6 mb-2">Certification:</h3>
          <ul className="list-disc list-inside font-robo text-base sm:text-base md:text-lg text-justify">
