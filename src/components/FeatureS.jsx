      ...
      <Slider {...settings}>
        {items.map((item, index) => (
          <div key={index} className="slider-box p-4 rounded-lg">
            ...
            />
            <p className="text-blue-600 font-semibold text-md md:text-base lg:text-lg font-os">
              {item.name}
            </p>
            {item.discription && (
              <p className="text-black text-justify md:text-base lg:text-lg font-robo">
                {expandedIndex === index
                  ? item.discription
