...
import {
  FaFacebook, FaTwitter, FaInstagram, FaLinkedin, FaYoutube, FaGoogle,
  FaPinterest, FaVimeoV, FaSnapchatGhost, FaSkype, FaAndroid,
  FaDribbble, FaTumblr, FaWifi
} from "react-icons/fa";
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 font-robo">
              ...
              <li><Link to="/vison" className="hover:text-gray-300">Vision Mission</Link></li>
              <li><Link to="/acquisition" className="hover:text-gray-300">Acquisition</Link></li>
              <li><Link to="/certification" className="hover:text-gray-300">Certification</Link></li>
              <li><Link to="/quality" className="hover:text-gray-300">Quality Assurance</Link></li>
              <li><Link to="/managment" className="hover:text-gray-300">Management</Link></li>
              <li><Link to="/recognition" className="hover:text-gray-300">Recognition</Link></li>
              <li><Link to="/corporate" className="hover:text-gray-300">Corporate</Link></li>
              <li><Link to="#" className="hover:text-gray-300">Facility</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 font-robo">
              <li><Link to="/consumer-electronics/led" className="hover:text-gray-300">LED TV</Link></li>
              <li><Link to="/consumer-electronics/split-ac" className="hover:text-gray-300">Air Conditioner</Link></li>
              <li><Link to="/consumer-electronics/washing" className="hover:text-gray-300">Washing Machine</Link></li>
              <li><Link to="/consumer-electronics/new-desert" className="hover:text-gray-300">Cooler</Link></li>
              <li><Link to="/consumer-electronics/refrigerators" className="hover:text-gray-300">Refrigerator</Link></li>
              <li><Link to="/consumer-electronics/geysers" className="hover:text-gray-300">Geysers</Link></li>
            </ul>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center border-t border-gray-700 pt-6 gap-4 sm:gap-0 text-center sm:text-left">
          ...
          <div className="flex flex-wrap justify-center sm:justify-end gap-4 order-1 sm:order-2">
            ...
            <a href="#" className="text-gray-400 hover:text-white text-xl"><FaPinterest /></a>
