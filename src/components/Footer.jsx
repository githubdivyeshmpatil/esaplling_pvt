...
const Footer = () => {
  return (
    ...
    <footer className="bg-[#000066] text-white pt-12 pb-4 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-8">
          {/* About Us Column */}
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-4 uppercase">About Us</h3>
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-gray-300">About Us</a></li>
              <li><a href="#" className="hover:text-gray-300">Vision Mission</a></li>
              <li><a href="#" className="hover:text-gray-300">Acquisition</a></li>
              <li><a href="#" className="hover:text-gray-300">Certification</a></li>
              <li><a href="#" className="hover:text-gray-300">Quality Assurance</a></li>
              <li><a href="#" className="hover:text-gray-300">Management</a></li>
              <li><a href="#" className="hover:text-gray-300">Recognition</a></li>
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-4 uppercase">Consumer Electronics</h3>
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-gray-300">LED TV</a></li>
              <li><a href="#" className="hover:text-gray-300">Air Conditioner</a></li>
              <li><a href="#" className="hover:text-gray-300">Washing Machine</a></li>
              <li><a href="#" className="hover:text-gray-300">Automatic Washing Machine</a></li>
              <li><a href="#" className="hover:text-gray-300">Refrigerator</a></li>
              <li><a href="#" className="hover:text-gray-300">Visi Cooler</a></li>
              <li><a href="#" className="hover:text-gray-300">Small Appliances</a></li>
            </ul>
          </div>

          {/* Auto Air Conditioning Column */}
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-4 uppercase">Auto Air Conditioning</h3>
            <ul className="space-y-2">
          ...
          {/* HVAC Column */}
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-4 uppercase">HVAC</h3>
            <ul className="space-y-2">
          ...
          {/* HVAC O & M Column */}
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-4 uppercase">HVAC O & M</h3>
            <ul className="space-y-2">
          ...
          {/* Harness Column */}
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-4 uppercase">Harness</h3>
            <ul className="space-y-2">
...
<div className="flex flex-col sm:flex-row justify-between items-center border-t border-gray-700 pt-6 gap-4 sm:gap-0 text-center sm:text-left">
  ...
  <div className="flex flex-wrap justify-center sm:justify-end gap-4 order-1 sm:order-2">
    ...
    <a href="#" className="text-gray-400 hover:text-white text-xl"><FaInstagram /></a>
    <a href="#" className="text-gray-400 hover:text-white text-xl"><FaLinkedin /></a>
    <a href="#" className="text-gray-400 hover:text-white text-xl"><FaYoutube /></a> <a href="#" className="text-gray-400 hover:text-white text-xl"><FaFacebook /></a>
    <a href="#" className="text-gray-400 hover:text-white text-xl"><FaTwitter /></a>
    <a href="#" className="text-gray-400 hover:text-white text-xl"><FaInstagram /></a>
    <a href="#" className="text-gray-400 hover:text-white text-xl"><FaLinkedin /></a>
    <a href="#" className="text-gray-400 hover:text-white text-xl"><FaYoutube /></a>
