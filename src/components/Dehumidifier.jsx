     ...
     <div className="max-w-9xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-4 text-justify text-black font-robo">
          <h2 className="text-3xl font-bold font-os">Dehumidifier</h2>
          <p>
          ...
          <p>
            Asthma, allergies, and other respiratory illness are the main health impacts to children and other residents of homes with excessive moisture. It also causes or contributes to other hazards to human health such as mold, cockroaches, dust mites, and peeling off lead paint etc.
          </p>
        </div>
