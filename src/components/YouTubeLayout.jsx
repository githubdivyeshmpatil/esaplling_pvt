...
></iframe>
        ...
        <div className="md:w-1/2 w-full text-black-800 text-justify">
          <h2 className="text-2xl font-bold mb-4">Next-Gen HVAC: Sustainable Engineering, Smart Controls, and Energy Optimization
 ...
 <div>
            <a
  href="#about"
  className="inline-flex items-center bg-blue-600 text-white px-6 py-3 shadow hover:bg-amber-700 transition duration-300"
>
